...
BurstPacket::BurstPacket(const char *name, short kind) : ::omnetpp::cPacket(name,kind)
{
    this->msgId = 0;
    this->timestamp = 0;
    this->arrivalTime = 0;
...
BurstPacket::BurstPacket(const BurstPacket& other) : ::omnetpp::cPacket(other)
{
    copy(other);
}
...
::omnetpp::simtime_t BurstPacket::getTimestamp() const
{
    return this->timestamp;
}

void BurstPacket::setTimestamp(::omnetpp::simtime_t timestamp)
{
...
unsigned int BurstPacket::getSize() const
{
    return this->size;
}

void BurstPacket::setSize(unsigned int size)
{
    this->size = size;
}
...
BurstPacketDescriptor::BurstPacketDescriptor() : omnetpp::cClassDescriptor("inet::BurstPacket", "omnetpp::cPacket")
{
...
std::string BurstPacketDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case 3: return ulong2string(pp->getSize());
        default: return "";
    }
}
...
bool BurstPacketDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case 3: pp->setSize(string2ulong(value)); return true;
